...
{    
    ...
    {
        private string _wumpusType = "WumpusActionVoteV7";
        private string _gameStream = "WumpusGameStreamV7";
        ...
        private string clientKey = "k+GZncLFtRsmcNXPzJxdv+wODBMnVUVIBUx6qRZ9NwY="; // configuration["ClientKey"];
